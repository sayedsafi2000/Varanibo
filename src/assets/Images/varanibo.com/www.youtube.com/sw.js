...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "web_masthead_disappearing_channel_icon_fix": true,
        "web_masthead_visited_channel_color_fix": true,
        "web_one_platform_error_handling": true,
        "web_prefer_local_wn_response": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20240702.09.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "BD",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20240702.09.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/1d05d8a6\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/1d05d8a6\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}